...
% referencias
\addbibresource{./files/gbTeXbib-20250425BATTAGLIACAMILASEMINARIO.bib}
...
\newcommand*\infofont[1]{\sf{\footnotesize 
\crop[font=infofont]
...
positivist}. \footnote{Jean-Paul Sartre, \emph{Crítica de la razón
...
representación\footnote{\emph{Ídem,} p. 58. La noción de \enquote{diferencia
  ...
  superior a la cosa misma}. Gilles Deleuze, \enquote{La concepción de la
...
necesariamente los excede y atraviesa por el medio}. \footnote{Fernando
  Gallego, \enquote{Prefacio a un libro necesario}, en Philippe Mengue,
...
intensidad lo que se dramatiza\footnote{Gilles Deleuze, \enquote{El método de
...
complejo de diferencias mutuamente ligadas}.\footnote{Fernando Gallego,
  \enquote{Prefacio a un libro necesario}{\ldots, \emph{op. cit}, p. 17}
...
Diferencia}.\footnote{Jacques Derrida, \emph{Introducción a} \enquote{\emph{El
...
sólo \enquote{representa} la voz. Esto significa que una y otra vez se repite la
...
mismo\footnote{Jacques Derrida, \enquote{La \emph{différance}}, en
...
que excede la alternativa de la presencia y de la ausencia\footnote{Jacques
  Derrida, \enquote{La \emph{différance}}\ldots, \emph{op. cit.}, p. 21. La
...
estructurado y diferente (de diferir) de las diferencias\footnote{Jacques
  Derrida, \enquote{La \emph{différance}}\ldots, \emph{op. cit.}, p. 12.}.
\end{quote}
...
reparto}.\footnote{Jean-Luc Nancy, \enquote{Las diferencias paralelas. Deleuze y
...
siempre diferencia de fuerzas --\emph{polemos}--, el mismo proceso de
...
en mí\footnote{Jacques Derrida, \enquote{Tendré que errar solo}, en \emph{Cada
...
con la alteridad)\footnote{Jacques Derrida, \enquote{Violencia y metafísica}, en
...
seguros de un suelo, de una morada y de una historia}\footnote{Jean-Luc
  Nancy, \enquote{Las diferencias paralelas. Deleuze y Derrida}, \emph{op.
  cit.}, p. 261.}.
...
orienta los procesos de significación --en los términos en que la hemos
...
puede desprender de su mera \emph{existencia} --la cual es claramente
...
materialidad --le fuera, del algún modo, inmanente-- o bien lo elementos
...
producciones anímicas que sólo tienen acceso y resultan susceptibles de
conocer a través de sus manifestaciones disfrazadas, es decir, sólo a
...
\chapter{Ontología nodal}

\author{Roque Farrán}

\section{Un materialismo del encuentro}
...
discursivos. Esta ha sido --y continúa siendo-- nuestra apuesta
ontológico-política.
